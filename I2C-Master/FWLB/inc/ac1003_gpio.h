...
#ifndef __AC1003_GPIO_H
#define __AC1003_GPIO_H
...
/**
  ...
  */
#define GPIO_AF_TIM1_CH2N_PA1         ((uint8_t)0x01)  /* TIM1 Alternate Function mapping */
#define GPIO_AF_TIM1_CH3_PA2          ((uint8_t)0x01)  /* TIM1 Alternate Function mapping */
#define GPIO_AF_TIM1_CH3N_PA3         ((uint8_t)0x01)  /* TIM1 Alternate Function mapping */
#define GPIO_AF_LPTIM_GATE_PB4        ((uint8_t)0x01)  /* LPTIM Alternate Function mapping */
...
#define GPIO_AF_TIM1_CH2_PC7          ((uint8_t)0x01)  /* TIM1 Alternate Function mapping */
#define GPIO_AF_TIM1_CH2_PD2          ((uint8_t)0x01)  /* TIM1 Alternate Function mapping */
#define GPIO_AF_TIM1_CH3N_PD3         ((uint8_t)0x01)  /* TIM1 Alternate Function mapping */
#define GPIO_AF_TIM1_CH1_PD4          ((uint8_t)0x01)  /* TIM1 Alternate Function mapping */
#define GPIO_AF_TIM1_CH1N_PD5         ((uint8_t)0x01)  /* TIM1 Alternate Function mapping */
...
/**
  ...
  */
#define GPIO_AF_PCA_CH2_PA3           ((uint8_t)0x02)  /* PCA Alternate Function mapping */
...
#define GPIO_AF_PCA_CH4_PD5           ((uint8_t)0x02)  /* PCA Alternate Function mapping */
...
#define GPIO_AF_RTC_OUT1HZ_PD4       ((uint8_t)0x03)  /* RTC_OUT1HZ Alternate Function mapping */
...
#define GPIO_AF_RTC_OUT1HZ_PA3       ((uint8_t)0x04)  /* RTC_1HZ Alternate Function mapping */
...
#define GPIO_AF_RTC_OUT1HZ_PD2       ((uint8_t)0x04)  /* RTC_1HZ Alternate Function mapping */
#define GPIO_AF_HXTL_OUT_PD3         ((uint8_t)0x04)  /* HXT Alternate Function mapping */
#define GPIO_AF_TIM10_TOG_PD4        ((uint8_t)0x04)  /* TIM10 Alternate Function mapping */
...
#define GPIO_AF_UART1_RX_PC7          ((uint8_t)0x05)  /* UART1 Alternate Function mapping */
#define GPIO_AF_UART1_TX_PD1          ((uint8_t)0x05)  /* UART1 Alternate Function mapping */
...
/**
  ...
  */
#define GPIO_AF_TIM10_TOG_PA1         ((uint8_t)0x06)  /*TIM10 Alternate Function mapping */
#define GPIO_AF_TIM10_TOGN_PA2        ((uint8_t)0x06)  /*TIM10 Alternate Function mapping */
#define GPIO_AF_PCA_ECI_PA3           ((uint8_t)0x06)  /*TIM0 Alternate Function mapping */
#define GPIO_AF_TIM11_TOG_PB5         ((uint8_t)0x06)  /*TIM11 Alternate Function mapping */
#define GPIO_AF_TIM11_TOGN_PB4        ((uint8_t)0x06)  /*TIM11 Alternate Function mapping */
#define GPIO_AF_PCA_CH1_PC3           ((uint8_t)0x06)  /*PCA Alternate Function mapping */
#define GPIO_AF_PCA_CH0_PC4           ((uint8_t)0x06)  /*PCA Alternate Function mapping */
#define GPIO_AF_TIM11_GATE_PC5        ((uint8_t)0x06)  /*TIM11 Alternate Function mapping */
#define GPIO_AF_TIM11_EXT_PC6         ((uint8_t)0x06)  /*TIM11 Alternate Function mapping */
#define GPIO_AF_LIRC_OUT_PC7          ((uint8_t)0x06)  /*LIRC Alternate Function mapping */
#define GPIO_AF_HIRC_OUT_PD1          ((uint8_t)0x06)  /*HIRC Alternate Function mapping */
...
#define GPIO_AF_TIM10_EXT_PD4         ((uint8_t)0x06)  /*TIM10 Alternate Function mapping */
#define GPIO_AF_TIM10_GATE_PD5        ((uint8_t)0x06)  /*TIM10 Alternate Function mapping */
#define GPIO_AF_LPTIMER_EXT_PD6       ((uint8_t)0x06)  /*LPTIMER Alternate Function mapping */

/**
  * @brief   AF 7 selection
  */
#define GPIO_AF_UART1_RX_PA1        ((uint8_t)0x07)  /* UART1 Alternate Function mapping   */
#define GPIO_AF_UART1_TX_PA2        ((uint8_t)0x07)  /* UART1 Alternate Function mapping   */
#define GPIO_AF_VCO_OUT_PA3         ((uint8_t)0x07)  /* VCO Alternate Function mapping     */
#define GPIO_AF_LVDOUT_PB5          ((uint8_t)0x07)  /* ADC Alternate Function mapping     */
#define GPIO_AF_1_WIRE_PC3          ((uint8_t)0x07)  /* 1_WIRE Alternate Function mapping  */
#define GPIO_AF_CLKMCO_PC4          ((uint8_t)0x07)  /* CLK MCO Alternate Function mapping */
#define GPIO_AF_LVDOUT_PC5          ((uint8_t)0x07)  /* LVD Alternate Function mapping     */
#define GPIO_AF_CLKMCO_PC6          ((uint8_t)0x07)  /* CLK MCO Alternate Function mapping */
#define GPIO_AF_LXT_OUT_PC7         ((uint8_t)0x07)  /* LXT Alternate Function mapping     */
...
#define GPIO_AF_UART0_TX_PD5        ((uint8_t)0x07)  /* UART0 Alternate Function mapping   */
#define GPIO_AF_UART0_RX_PD6        ((uint8_t)0x07)  /* UART0 Alternate Function mapping   */
...
#define GPIO_AF_VCIN0_PD2       ((uint8_t)0x0F)  /* VCIN Alternate Function mapping  */
#define GPIO_AF_VCIN1_PC5       ((uint8_t)0x0F)  /* VCIN Alternate Function mapping  */
#define GPIO_AF_VCIN2_PD4       ((uint8_t)0x0F)  /* VCIN Alternate Function mapping  */

#define IS_GPIO_AF(GPIO_AF)     (((GPIO_AF >= 0) &&(GPIO_AF<= 8))||\
                                 (GPIO_AF== 0x0f))
