...
#ifndef __AC1003_RTC_H
#define __AC1003_RTC_H
...
ErrorStatus RTC_GetTime(RTC_TypeDef *RTCx, uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct);
...
ErrorStatus RTC_GetDate(RTC_TypeDef *RTCx, uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct);
