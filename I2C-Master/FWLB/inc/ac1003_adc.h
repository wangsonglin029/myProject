...
#ifndef __AC1003_ADC_H
#define __AC1003_ADC_H
...
#define ADC_SAMPLE_8CYCLE       ((uint32_t)0x00000800)
#define IS_ADC_SAMPLE_CYCLE(CYCLE)  ((CYCLE == ADC_SAMPLE_4CYCLE) ||\
                                     (CYCLE == ADC_SAMPLE_8CYCLE))
...
uint32_t ADC_CompareControlCmd(ADC_TypeDef* ADCx, uint32_t ControlCmd, FunctionalState NewState);
void ADC_ExternalTrigInjectedConvConfig(ADC_TypeDef* ADCx, uint32_t ExternalTrigInjecConv);
