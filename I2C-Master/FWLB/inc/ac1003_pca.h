...
#ifndef __AC1003_PCA_H
#define __AC1003_PCA_H
...
void PCA_SetPwm_output(PCA_TypeDef* PCAx, PCA_Channel channel, FunctionalState OutputPolarityReversal, uint8_t valuel, uint8_t valueh, FunctionalState NewStatus);
