...
//  /* Check the parameters */
    ...
    if (TIMx == TIM1)
    {
        RCC_PeriphResetCmd(RCC, RCC_APBPeriph_TIM1RST, ENABLE);
        RCC_PeriphResetCmd(RCC, RCC_APBPeriph_TIM1RST, DISABLE);
    }
    else
    {
        if (TIMx == TIM2)
        {
            RCC_PeriphResetCmd(RCC, RCC_APBPeriph_TIM2RST, ENABLE);
            RCC_PeriphResetCmd(RCC, RCC_APBPeriph_TIM2RST, DISABLE);
        }
    }
}
...
/**
  ...
  * @retval None
  */
void ADVTIM_TimeBaseInit(ADVTIM_TypeDef* TIMx, \
                         ADVTIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct)
{
    uint16_t tmpcr1 = 0;
...
/**
  ...
  * @retval None
  */
void ADVTIM_ITConfig(ADVTIM_TypeDef* TIMx, \
                     uint16_t TIM_IT, \
...
/**
  ...
  * @retval None
  */
void ADVTIM_GenerateEvent(ADVTIM_TypeDef* TIMx, uint16_t EventSource)
{
    /* Check the parameters */
    assert_param(IS_TIM_ALL_PERIPH(TIMx));
...
/**
  ...
  * @retval None
  */
void ADVTIM_ITRxExternalClockConfig(ADVTIM_TypeDef* TIMx, \
...
/**
  ...
  * @retval None
  */
void ADVTIM_TIxExternalClockConfig(ADVTIM_TypeDef* TIMx, \
...
/**
  ...
  * @retval None
  */
void ADVTIM_ETRClockMode1Config(ADVTIM_TypeDef* TIMx, \
...
/**
  ...
  * @retval None
  */
void ADVTIM_ETRClockMode2Config(ADVTIM_TypeDef* TIMx, \
                                uint16_t TIM_ExtTRGPrescaler, \
                                uint16_t TIM_ExtTRGPolarity, \
                                uint16_t ExtTRGFilter)
{
...
/**
  ...
  * @retval None
  */
void ADVTIM_ETRConfig(ADVTIM_TypeDef* TIMx, \
                      uint16_t TIM_ExtTRGPrescaler, \
                      uint16_t TIM_ExtTRGPolarity, \
                      uint16_t ExtTRGFilter)
{
...
/**
  ...
  * @retval None
  */
void ADVTIM_PrescalerConfig(ADVTIM_TypeDef* TIMx, \
                            uint16_t Prescaler, \
...
/**
  ...
  * @retval None
  */
void ADVTIM_EncoderInterfaceConfig(ADVTIM_TypeDef* TIMx, \
...
/**
  ...
  * @retval None
  */
void ADVTIM_CCxCmd(ADVTIM_TypeDef* TIMx, \
...
/**
  ...
  * @retval None
  */
void ADVTIM_CCxNCmd(ADVTIM_TypeDef* TIMx, \
                    uint16_t TIM_Channel, \
                    uint16_t TIM_CCxN)
{
    uint16_t tmp = 0;
...
/**
  ...
  * @retval None
  */
void ADVTIM_SelectOCxM(ADVTIM_TypeDef* TIMx, \
                       uint16_t TIM_Channel, \
                       uint16_t TIM_OCMode)
{
    uint32_t tmp = 0;
...
/**
  ...
  * @retval None
  */
static void TI1_Config(ADVTIM_TypeDef* TIMx, \
                       uint16_t TIM_ICPolarity, \
...
/**
  ...
  * @retval None
  */
static void TI2_Config(ADVTIM_TypeDef* TIMx, \
                       uint16_t TIM_ICPolarity, \
                       uint16_t TIM_ICSelection,
                       uint16_t TIM_ICFilter)
{
...
/**
  ...
  * @retval None
  */
static void TI3_Config(ADVTIM_TypeDef* TIMx, \
                       uint16_t TIM_ICPolarity, \
                       uint16_t TIM_ICSelection, \
                       uint16_t TIM_ICFilter)
{
...
/**
  ...
  * @retval None
  */
static void TI4_Config(ADVTIM_TypeDef* TIMx, \
                       uint16_t TIM_ICPolarity, \
                       uint16_t TIM_ICSelection, \
                       uint16_t TIM_ICFilter)
{
